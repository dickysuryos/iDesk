...
{
    Serial.begin(115200);
    u8g2_sw_ssd1306.begin(); // start the u8g2 library
    SampleSecureServer();
}
void loop()
{
...
//         u8g2_sw_ssd1306.drawStr(0, 10, "Msg:");
//         String line1 = lastMessage.substring(0, 21);
//         u8g2_sw_ssd1306.drawUTF8(0, 26, line1.c_str());
//         if (lastMessage.length() > 21) {
//             u8g2_sw_ssd1306.drawStr(0, 42, "...");
//         }
